...
--
-- Host: localhost:3306
-- Generation Time: Mar 25, 2021 at 08:42 PM
...
CREATE TABLE `tbl_invoice` (
  ...
  `mata_uang` varchar(60) DEFAULT NULL,
...
INSERT INTO `tbl_invoice` (`no_invoice`, `tanggal_dibuat`, `mata_uang`, `ppn`, `biayakirim`, `kode_bank`, `no_suratjalan`, `kode_manager`, `tgl_jatuhtempo`) VALUES
('FT/12/02/2021', '2021-02-12 13:10:35', 'IDR', NULL, NULL, 'BCA', 'SJ/12022021/PO2', 'MGR192301', '2021-02-13 14:00:00'),
('FT/30/01/2021', '2021-01-30 02:46:14', 'IDR', NULL, NULL, 'BCA', 'SJ/30012021/PO1', 'MGR192301', '2021-02-28 15:00:00');
...
CREATE TABLE `tbl_partner` (
  ...
  `nama_partner` varchar(60) DEFAULT NULL,
  `alamat_partner` varchar(120) DEFAULT NULL,
...
('B7623991', 'Monitor Led Samsung 22SF350 - 22 Inch PC Komputer - VGA HDMI', 25, 25, 'Unit', 1325000);
...
CREATE TABLE `tbl_rek_perusahaan` (
  `kode_bank` varchar(60) NOT NULL,
  `no_rekening` int(120) DEFAULT NULL,
  `atas_nama` varchar(120) DEFAULT NULL,
  `cabang` varchar(60) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
('BCA', 21, 'PT. PLASMA TECH INDONESIA', 'Bekasi');
...
INSERT INTO `tbl_staff` (`no_staff`, `nama_lengkap`, `posisi`) VALUES
...
(1, 'FT/30/01/2021', 'PO-1/01/2021', '2801923813', 'CM0123', 'B7623984', '2021-02-10 11:47:12', 10),
(2, 'FT/30/01/2021', 'PO-1/01/2021', '2801923813', 'CM0123', 'B7623985', '2021-02-10 11:47:14', 26),
(3, 'FT/30/01/2021', 'PO-1/01/2021', '2801923813', 'CM0123', 'B7623986', '2021-02-10 11:47:19', 25),
(4, 'FT/30/01/2021', 'PO-1/01/2021', '2801923813', 'CM0123', 'B7623987', '2021-02-10 11:47:23', 25),
(5, 'FT/30/01/2021', 'PO-1/01/2021', '2801923813', 'CM0123', 'B7623988', '2021-02-10 11:47:25', 8),
(6, 'FT/30/01/2021', 'PO-1/01/2021', '2801923813', 'CM0123', 'B7623989', '2021-02-10 11:47:33', 12),
(7, 'FT/30/01/2021', 'PO-1/01/2021', '2801923813', 'CM0123', 'B7623990', '2021-02-10 11:47:35', 10),
(8, 'FT/30/01/2021', 'PO-1/01/2021', '2801923813', 'CM0123', 'B7623991', '2021-02-10 11:47:37', 5),
(9, 'FT/12/02/2021', 'PO-2/02/2021', '8912371237', 'CM1239', 'B7623990', '2021-02-10 20:43:37', 15),
(10, 'FT/12/02/2021', 'PO-2/02/2021', '8912371237', 'CM1239', 'B7623991', '2021-02-10 20:43:39', 12);
...
ALTER TABLE `tbl_invoice`
  ...
  ADD KEY `fk_invoice2rekeningperusahaan` (`kode_bank`),
  ADD KEY `fk_invoice2suratjalan` (`no_suratjalan`),
  ADD KEY `fk_invoice2manager` (`kode_manager`);
...
ALTER TABLE `tbl_transaksi`
  ...
  ADD KEY `fk_transaksi2invoice` (`no_invoice`),
  ADD KEY `fk_transaksi2po` (`no_po`),
  ADD KEY `fk_transaksi2staff` (`no_staff`),
  ADD KEY `fk_transaksi2partner` (`kode_partner`),
  ADD KEY `fk_transaksi2produk` (`kode_produk`);
...
--
ALTER TABLE `tbl_invoice`
  ADD CONSTRAINT `fk_invoice2manager` FOREIGN KEY (`kode_manager`) REFERENCES `tbl_manager` (`kode_manager`),
  ADD CONSTRAINT `fk_invoice2rekeningperusahaan` FOREIGN KEY (`kode_bank`) REFERENCES `tbl_rek_perusahaan` (`kode_bank`),
  ADD CONSTRAINT `fk_invoice2suratjalan` FOREIGN KEY (`no_suratjalan`) REFERENCES `tbl_suratjalan` (`no_suratjalan`);

--
-- Constraints for table `tbl_transaksi`
--
ALTER TABLE `tbl_transaksi`
  ADD CONSTRAINT `fk_transaksi2invoice` FOREIGN KEY (`no_invoice`) REFERENCES `tbl_invoice` (`no_invoice`),
  ADD CONSTRAINT `fk_transaksi2partner` FOREIGN KEY (`kode_partner`) REFERENCES `tbl_partner` (`kode_partner`),
  ADD CONSTRAINT `fk_transaksi2po` FOREIGN KEY (`no_po`) REFERENCES `tbl_po` (`no_po`),
  ADD CONSTRAINT `fk_transaksi2produk` FOREIGN KEY (`kode_produk`) REFERENCES `tbl_produk` (`kode_produk`),
  ADD CONSTRAINT `fk_transaksi2staff` FOREIGN KEY (`no_staff`) REFERENCES `tbl_staff` (`no_staff`);
